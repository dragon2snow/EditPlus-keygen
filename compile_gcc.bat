...
:gcc_FAILED
echo.
echo GCC is not found! Please check your GCC installation and environment configuration!
...
:windres_FAILED
echo.
echo WINDRES is not found! Please check your GCC installation!
pause
goto quit
